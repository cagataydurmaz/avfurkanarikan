...
const service = zeytinburnuServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(zeytinburnu, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={zeytinburnu} service={service} allServices={zeytinburnuServices} />
    </>
  );
}
