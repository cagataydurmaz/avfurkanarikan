...
const service = sancaktepeServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(sancaktepe, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={sancaktepe} service={service} allServices={sancaktepeServices} />
    </>
  );
}
