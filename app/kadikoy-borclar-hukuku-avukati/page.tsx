...
const service = kadikoyServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(kadikoy, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={kadikoy} service={service} allServices={kadikoyServices} />
    </>
  );
}
