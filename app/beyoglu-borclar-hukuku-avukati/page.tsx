...
const service = beyogluServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(beyoglu, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={beyoglu} service={service} allServices={beyogluServices} />
    </>
  );
}
