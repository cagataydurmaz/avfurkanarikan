...
const service = beylikduzuServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(beylikduzu, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={beylikduzu} service={service} allServices={beylikduzuServices} />
    </>
  );
}
