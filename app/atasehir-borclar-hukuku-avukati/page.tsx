...
const service = atasehirServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(atasehir, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={atasehir} service={service} allServices={atasehirServices} />
    </>
  );
}
