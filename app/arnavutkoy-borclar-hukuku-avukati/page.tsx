...
const service = arnavutkoyServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(arnavutkoy, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={arnavutkoy} service={service} allServices={arnavutkoyServices} />
    </>
  );
}
