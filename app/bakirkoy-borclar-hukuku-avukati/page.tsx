...
const service = bakirkoyServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(bakirkoy, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={bakirkoy} service={service} allServices={bakirkoyServices} />
    </>
  );
}
