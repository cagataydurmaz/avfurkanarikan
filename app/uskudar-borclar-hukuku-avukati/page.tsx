...
const service = uskudarServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(uskudar, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={uskudar} service={service} allServices={uskudarServices} />
    </>
  );
}
