...
export const metadata: Metadata = {
  ...
  description:
    "Ceza, iş ve gayrimenkul hukukunda dava takibi ve hukuki danışmanlık hizmeti. İstinye, Sarıyer / İstanbul.",
  keywords: [
    "avukat",
    "İstanbul avukat",
    "ceza avukatı",
  ...
  "@graph": [
    {
      ...
      email: "info@furkanarikan.av.tr",
      address: {
        "@type": "PostalAddress",
        streetAddress: "[Adres Placeholder]",
        addressLocality: "İstinye, Sarıyer",
