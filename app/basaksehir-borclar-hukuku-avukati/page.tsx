...
const service = basaksehirServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(basaksehir, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={basaksehir} service={service} allServices={basaksehirServices} />
    </>
  );
}
