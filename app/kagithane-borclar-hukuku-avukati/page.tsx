...
const service = kagithaneServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(kagithane, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={kagithane} service={service} allServices={kagithaneServices} />
    </>
  );
}
