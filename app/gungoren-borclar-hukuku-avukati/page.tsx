...
const service = gungorenServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(gungoren, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={gungoren} service={service} allServices={gungorenServices} />
    </>
  );
}
