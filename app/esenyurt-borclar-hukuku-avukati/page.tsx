...
const service = esenyurtServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(esenyurt, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={esenyurt} service={service} allServices={esenyurtServices} />
    </>
  );
}
