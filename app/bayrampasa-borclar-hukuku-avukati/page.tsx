...
const service = bayrampasaServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(bayrampasa, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={bayrampasa} service={service} allServices={bayrampasaServices} />
    </>
  );
}
