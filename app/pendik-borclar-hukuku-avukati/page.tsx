...
const service = pendikServices.find((s) => s.slug === "borclar-hukuku")!;
...
const jsonLd = buildPseoJsonLd(pendik, service);
...
export default function Page() {
  return (
    <>
      ...
      <PseoPage district={pendik} service={service} allServices={pendikServices} />
    </>
  );
}
